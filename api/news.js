...
module.exports = async function handler(req, res) {
  ...
  const path = `/rest/v1/news_items?zone=eq.${zone}&order=published_at.desc&limit=${limit}&select=id,guid,title,title_en,summary,summary_en,source,url,published_at,sentiment`;
