...
(function() {
  ...
  function ltEnhanceToolsDropdown() {
    ...
    var SUBS = {
      'journal-presentation':    [['Présentation','Overview','/v2/journal-presentation'], ['Ouvrir le journal','Open the journal','/v2/journal']],
      'analyzer-presentation':   [['Présentation','Overview','/v2/analyzer-presentation'], ["Ouvrir l'analyseur",'Open the analyzer','/v2/app']],
      'calendrier-presentation': [['Présentation','Overview','/v2/calendrier-presentation'], ['Ouvrir le calendrier','Open the calendar','/v2/calendrier'], ['Édition du jour','Daily edition','/v2/eco-edition']],
      'patrimoine-presentation': [['Présentation','Overview','/v2/patrimoine-presentation'], ['Portefeuille','Portfolio','/v2/patrimoine']]
    };
