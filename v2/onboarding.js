...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent =
      '.ob{position:fixed;inset:0;z-index:100001;display:flex;align-items:center;justify-content:center;padding:20px;background:rgba(7,9,12,.86);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);animation:obFade .3s ease}'
      + '@keyframes obFade{from{opacity:0}to{opacity:1}}'
      + '.ob__box{position:relative;width:100%;max-width:520px;max-height:92vh;overflow:auto;background:var(--bg-elevated,#161B24);border:1px solid var(--border-subtle,#1C212A);border-radius:var(--r-lg,12px);padding:30px 30px 26px;box-shadow:0 40px 90px rgba(0,0,0,.65);scrollbar-width:thin}'
      + '.ob__box::before{content:"";position:absolute;top:0;left:40px;right:40px;height:1px;background:linear-gradient(90deg,transparent,var(--accent-glow,rgba(127,184,232,.35)),transparent)}'
      ...
      + '.ob__dot.on{width:18px;background:var(--accent-bright,#BFDCF5)}'
      ...
      + '.ob__ic{width:46px;height:46px;border-radius:12px;display:flex;align-items:center;justify-content:center;background:var(--accent-glow-soft,rgba(127,184,232,.12));color:var(--accent,#7FB8E8);margin-bottom:16px}'
      ...
      + '.ob__opt{display:flex;align-items:center;gap:12px;width:100%;text-align:left;padding:14px 16px;background:var(--bg-base,#07090C);border:1px solid var(--border-subtle,#1C212A);border-radius:var(--r-md,8px);color:var(--text-body,#C3CAD4);font-family:var(--font-text,"Inter",sans-serif);font-size:14px;font-weight:600;cursor:pointer;transition:border-color .15s,background .15s,color .15s,transform .15s}'
      + '.ob__opt:hover{border-color:var(--accent,#7FB8E8);color:var(--text-title,#F2F4F7);background:var(--accent-glow-soft,rgba(127,184,232,.08));transform:translateY(-1px)}'
      + '.ob__opt.sel{border-color:var(--accent,#7FB8E8);background:var(--accent-glow-soft,rgba(127,184,232,.14));color:var(--text-title,#F2F4F7)}'
      + '.ob__opt b{width:24px;height:24px;border-radius:6px;display:inline-flex;align-items:center;justify-content:center;background:var(--bg-surface,#10141B);border:1px solid var(--border-subtle,#1C212A);font-family:var(--font-mono,"JetBrains Mono",monospace);font-size:11px;color:var(--text-muted,#7E8794);flex:none}'
      // étape tarifs
      ...
      + '.ob__plan{position:relative;border:1px solid var(--border-subtle,#1C212A);border-radius:var(--r-md,8px);background:var(--bg-base,#07090C);padding:18px 16px;display:flex;flex-direction:column;gap:6px}'
      + '.ob__plan--reco{border-color:var(--accent,#7FB8E8);box-shadow:0 0 0 1px var(--accent-glow,rgba(127,184,232,.35)),0 0 28px var(--accent-glow-soft,rgba(127,184,232,.18))}'
      + '.ob__reco{position:absolute;top:-9px;left:50%;transform:translateX(-50%);font-family:var(--font-mono,"JetBrains Mono",monospace);font-size:8.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#07090C;background:var(--accent,#7FB8E8);border-radius:50px;padding:3px 9px;white-space:nowrap}'
      ...
      + '.ob__plan__cta:hover{border-color:var(--accent,#7FB8E8)}'
      + '.ob__plan__cta--reco{background:var(--accent,#7FB8E8);border-color:transparent;color:#07090C}'
      + '.ob__plan__cta--reco:hover{background:var(--accent-bright,#BFDCF5)}'
